define ['cmx/gizmos/entity_gizmo'], (EntityGizmo) ->
  ...
  class BubbleGizmo extends EntityGizmo
    ...
    build: ->
      ...
      @ΔskeletonGizmo = base.append("g").attr("class", "cmx-gizmo cmx-bubble")
      ...
      data = @entity.skelet.bonesWithIndices @entity.bubbleBones
      @ΔskeletonGizmo.selectAll(".cmx-control")
        .data(data)
        .enter()
          .append("circle")
